      ...
      <div className="max-w-7xl mx-auto px-4 py-10 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mt-3 md:mt-4 text-gray-100 text-sm md:text-base">
              Spécialisé dans l'installation de tous types et formes de planchers en bois, intérieurs et extérieurs.
              Notre devise est la qualité.
            </p>
            <div className="flex space-x-3 md:space-x-4 mt-4 md:mt-6">
              ...
              />
              <SocialLink href="https://www.instagram.com/decorasol_top" icon={<Instagram size={16} />} />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 md:space-y-2">
              ...
              <FooterLink href="/">Galerie</FooterLink>
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-sm md:text-base">Marrakech, Maroc</span>
              </li>
              <li className="flex items-center">
                <Phone className="mr-2 h-4 w-4 md:h-5 md:w-5 text-gray-100" />
                <span className="text-sm md:text-base">+212 666-865356</span>
              </li>
              <li className="flex items-center">
                <Mail className="mr-2 h-4 w-4 md:h-5 md:w-5 text-gray-100" />
                <span className="text-sm md:text-base">Decorasol21@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/20 mt-8 md:mt-12 pt-6 md:pt-8 flex flex-col md:flex-row md:justify-between text-xs md:text-sm text-gray-100">
          <p className="text-center md:text-left">
            &copy; {new Date().getFullYear()} Decora Sol. Tous droits réservés.
          </p>
